<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2" src="{{asset('admin/assets/img/icons/left-arrow-from-left.svg')}}"
                        width="20" alt="" />
                    <div class="flex-1">
                        <h5 class="fs-0">RTL Mode</h5>
                        <p class="fs--1 mb-0">Switch your language direction </p><a class="fs--1"
                            href="{{asset('admin/documentation/customization/configuration.html')}}">RTL Documentation</a>
                    </div>
                </div>
            ...
            <hr />
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2" src="{{asset('admin/assets/img/icons/arrows-h.svg')}}" width="20"
                        alt="" />
                    <div class="flex-1">
                        <h5 class="fs-0">Fluid Layout</h5>
                        <p class="fs--1 mb-0">Toggle container layout system </p><a class="fs--1"
                            href="{{asset('admin/documentation/customization/configuration.html')}}">Fluid Documentation</a>
                    </div>
                </div>
                <div class="form-check form-switch">
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2" src="{{asset('admin/assets/img/icons/paragraph.svg')}}" width="20"
                    alt="" />
                <div class="flex-1">
                    ...
                    <div>
                        <select class="form-select form-select-sm" aria-label="Navbar position"
                            ...
                            <option value="vertical"
                                data-page-url="{{asset('admin/modules/components/navs-and-tabs/vertical-navbar.html')}}">Vertical</option>
                            <option value="top" data-page-url="{{asset('admin/modules/components/navs-and-tabs/top-navbar.html')}}">Top
                            </option>
                            <option value="combo" data-page-url="{{asset('admin/modules/components/navs-and-tabs/combo-navbar.html')}}">
                                Combo</option>
                            <option value="double-top"
                                data-page-url="{{asset('admin/modules/components/navs-and-tabs/double-top-navbar.html')}}">Double Top
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <p> <a class="fs--1" href="{{asset('admin/modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles')}}">See
                    Documentation</a></p>
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                                class="img-fluid img-prototype" src="{{asset('admin/assets/img/generic/default.png')}}" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype" src="{{asset('admin/assets/img/generic/inverted.png')}}" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                class="img-fluid img-prototype" src="{{asset('admin/assets/img/generic/card.png')}}" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype" src="{{asset('admin/assets/img/generic/vibrant.png')}}" alt="" /><span
                                class="label-text"> Vibrant</span></label>
                    </div>
                </div>
            </div>
            <div class="text-center mt-5"><img class="mb-4" src="{{asset('admin/vendors/popper/popper.min.js')}}assets/img/icons/spot-illustrations/47.png" alt=""
                    width="120" />
