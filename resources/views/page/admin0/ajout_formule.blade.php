                ...
                <div class="tab-pane preview-tab-pane active" role="tabpanel"
                    ...
                    <form action="{{ route('save_formule') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="nom_formule" class="form-control" id="basic-form-name" type="text" placeholder="Name" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-form-name">Titre</label>
                            <input name="titre_formule" class="form-control" id="basic-form-name" type="text" placeholder="Name" />
                        </div>
