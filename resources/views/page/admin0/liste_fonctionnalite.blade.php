        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h2 class="mb-0" data-anchor="data-anchor">La liste des fonctionnalites</h2>
                </div>
                <div class="col-8 col-sm-auto text-end ps-2"> 
                    <div id="table-customers-replace-element" class="">
                        <a href="{{ route('ajout_fonctionnalite') }}" class="btn btn btn-success btn-sm" type="button">
                    ...
                    <div id="tableExample2"
                        ...
                        <div class="table-responsive scrollbar">
                            <table class="table table-bordered table-striped fs--1 mb-0">
                                ...
                                <tbody class="list">
                                    @foreach ($fonctionnalite_formules as $fonctionnalite_formule)
                                    <tr>
                                        <td class="name">{{ $fonctionnalite_formule->id }}</td>
