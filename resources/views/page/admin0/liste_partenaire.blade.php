        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h2 class="mb-0" data-anchor="data-anchor">La liste de nos partenaires</h2>
                </div>
                <div class="col-8 col-sm-auto text-end ps-2"> 
                    <div id="table-customers-replace-element" class="">
                        <a href="{{ route('ajout_partenaire') }}" class="btn btn btn-success btn-sm" type="button">
                        ...
                        <div class="table-responsive scrollbar">
                            <table class="table table-bordered table-striped fs--1 mb-0">
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        <td class="name">{{ $partenaire->id }}</td>
                                        <td class="name"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="{{ asset('storage/'.$partenaire->image_partenaire) }}" alt="" width="100"></td>
                                        <td>
                                            <div class="flex-1">
                                                <h5 class="mb-0 fs--1">{{ $partenaire->nom_partenaire }}</h5>
                                            </div>
                                        </td>
                                        <td class="age">
                                            <a href="{{ route('supprime_partenaire',['id' => $partenaire->id]) }}" class="btn btn-falcon-primary" type="button">
                                                <span class="fs-2 text-danger fas fa-trash" data-fa-transform="shrink-3"></span>
                                            </a>
                                            <a href="{{ route('edit_partenaire',['id' => $partenaire->id]) }}" class="btn btn-falcon-primary" type="button">
