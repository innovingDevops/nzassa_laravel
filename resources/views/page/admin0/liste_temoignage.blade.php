        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h2 class="mb-0" data-anchor="data-anchor">La liste des témoignages</h2>
                </div>
                <div class="col-8 col-sm-auto text-end ps-2"> 
                    <div id="table-customers-replace-element" class="">
                        <a href="{{ route('ajout_temoignage') }}" class="btn btn btn-success btn-sm" type="button">
                            ...
                            <table class="table table-bordered table-striped fs--1 mb-0">
                                <thead class="bg-200 text-900">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="name">Profession</th>
                                        <th class="sort" data-sort="name">Témoignage</th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        <td class="name">{{ $temoignage->id }}</td>
                                            <td class="name align-middle white-space-nowrap py-2">
                                                <div class="d-flex d-flex align-items-center">
                                                <div class="avatar avatar-xl me-2">
                                                    <img class="rounded-circle" src="{{ asset('storage/'.$temoignage->image_temoignage) }}" alt="">
                    
                                                </div>
                                                <div class="flex-1">
                                                    <h5 class="mb-0 fs--1">{{ $temoignage->nom_temoignage }}</h5>
                                                </div>
                                                </div>
                                            </td>
                                        <td class="name">{{ $temoignage->profession_temoignage }}</td>
                                        <td class="name">{{ $temoignage->detail_temoignage }}</td>
                                        <td class="age">
                                            <a href="{{ route('supprime_temoignage',['id' => $temoignage->id]) }}" class="btn btn-falcon-primary" type="button">
                                                <span class="fs-2 text-danger fas fa-trash" data-fa-transform="shrink-3"></span>
                                            </a>
                                            <a href="{{ route('edit_temoignage',['id' => $temoignage->id]) }}" class="btn btn-falcon-primary" type="button">
