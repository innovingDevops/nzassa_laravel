            ...
            <div class="col-lg-12 pe-lg-2">
              <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                  <form class="row g-3" action="{{ route('save_setting') }}" method="post">
                    @csrf
                    <div class="col-lg-6">
                      <label class="form-label" for="first-name">Objet </label>
                      <input name="cle" class="form-control" id="first-name" type="text"  />
                    </div>
                    
                    <div class="col-lg-12">
                      <label class="form-label" for="email3">Valeur</label>
                      <input name="valeur" class="form-control" id="email3" type="text"  />
                    </div>
